...
python3 -m src.analysis.demo_delirium_case --thesis          # thesis case summaries (recommended)
python3 -m src.analysis.demo_delirium_case --html              # browser preview (see docs/demo/DEMO_GUIDE.md)
