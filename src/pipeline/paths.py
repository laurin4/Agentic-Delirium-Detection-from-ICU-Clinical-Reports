...
PATIENT_VS_BASELINE_PATH = COMPARISONS_DIR / "patient_vs_baseline_comparison.csv"
PATIENT_VS_BASELINE_EXCLUDED_PATH = (
    COMPARISONS_DIR / "patient_vs_baseline_excluded_missing_baseline.csv"
)
...
EVALUATION_PATIENT_LEVEL_DIR = EVALUATION_DIR / "patient_level"
EVALUATION_PATIENT_LEVEL_TABLES_DIR = EVALUATION_PATIENT_LEVEL_DIR / "tables"
EVALUATION_PATIENT_LEVEL_PLOTS_DIR = EVALUATION_PATIENT_LEVEL_DIR / "plots"
EVALUATION_PATIENT_LEVEL_SUMMARY_PATH = (
    EVALUATION_PATIENT_LEVEL_TABLES_DIR / "binary_baseline_summary.csv"
)
EVALUATION_PATIENT_LEVEL_CONFUSION_COUNTS_PATH = (
    EVALUATION_PATIENT_LEVEL_TABLES_DIR / "binary_baseline_confusion_counts.csv"
)
EVALUATION_PATIENT_LEVEL_REPORT_PATH = EVALUATION_PATIENT_LEVEL_DIR / "report.txt"
EVALUATION_PATIENT_LEVEL_AGGREGATE_PATH = (
    EVALUATION_PATIENT_LEVEL_DIR / "patient_level_predictions.csv"
)
